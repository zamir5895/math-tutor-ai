...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#584DB2] to-[#20223B] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-5 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            <img src={logotipo} alt="MathLearn Logo" className="h-15 w-15 mr-2" />
            <h1 className="text-6xl font-bold text-white">Matemix</h1>
          </div>
          <p className="text-xl text-white max-w-4xl mx-auto font-semibold text-[17px]">
            Plataforma inteligente para aprender y reforzar matemáticas de forma personalizada
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-10 items-start mb-12 max-w-6xl mx-auto">
          <div className="space-y-6">
            <Card>
              <CardHeader className="text-center">
                <BookOpen className="h-6.5 w-8 text-blue-600 mx-auto mb-2" />
            ...
            <Card>
              <CardHeader className="text-center">
                <TrendingUp className="h-6.5 w-8 text-green-600 mx-auto mb-2" />
            ...
            <Card>
              <CardHeader className="text-center">
                <Users className="h-6.5 w-8 text-purple-600 mx-auto mb-2" />
